...
struct TreeMutationTests {
    ...
    func insertAtRoot() {
        ...
        let result = insertNodes(into: tree, nodes: [node("B")], at: .atIndex(parentID: nil, index: 1))
    ...
    func insertAtIndexInParent() {
        ...
        let result = insertNodes(into: tree, nodes: [node("B")], at: .atIndex(parentID: "parent", index: 1))
    ...
    func moveBetweenSiblings() {
        let tree = [node("A"), node("B"), node("C")]
        let result = moveNodes(in: tree, ids: Set(["C"]), to: .atIndex(parentID: nil, index: 0))
        #expect(result.count == 3)
    ...
    func moveForward() {
        ...
        let tree = [node("A"), node("B"), node("C")]
        let result = moveNodes(in: tree, ids: Set(["A"]), to: .atIndex(parentID: nil, index: 2))
        #expect(result.count == 3)
    ...
    func moveToEnd() {
        let tree = [node("A"), node("B"), node("C")]
        let result = moveNodes(in: tree, ids: Set(["A"]), to: .atIndex(parentID: nil, index: 3))
        #expect(result.count == 3)
        #expect(result[0].id == "B")
    ...
    func moveIntoDifferentParent() {
        ...
        let result = moveNodes(in: tree, ids: Set(["A"]), to: .atIndex(parentID: "P2", index: 0))
    ...
    func dropAtRoot() {
        ...
        let allowed = canDrop(in: tree, draggedIDs: Set(["A"]), onto: .atIndex(parentID: nil, index: 0))
        #expect(allowed == true)
    }
    ...
    func cannotDropAsChildOfDragged() {
        let tree = [node("A", children: [node("B")]), node("C")]
        let allowed = canDrop(in: tree, draggedIDs: Set(["A"]), onto: .atIndex(parentID: "A", index: 0))
        #expect(allowed == false)
    }
    ...
    func cannotDropContainerIntoSection() {
        ...
        let allowed = canDrop(in: tree, draggedIDs: Set(["S1"]), onto: .intoSection("S2"))
        #expect(allowed == false)
    }
    ...
    func cannotDropContainerBetweenChildrenOfSection() {
        ...
        let allowed = canDrop(in: tree, draggedIDs: Set(["S1"]), onto: .atIndex(parentID: "S2", index: 1))
        #expect(allowed == false)
    }
    ...
    func cannotDropNodeWithChildrenIntoSection() {
        ...
        let allowed = canDrop(in: tree, draggedIDs: Set(["A"]), onto: .intoSection("B"))
        #expect(allowed == false)
    }
}
